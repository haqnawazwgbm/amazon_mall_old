				...
				<div class="col-md-12">
					<div class="panel panel-default" id="usersTable">
						...
						/*$purchases = $this->Admin->DJoin(
							'A.owners,A.sale_id,D.project_name,D.project_location,B.unit_type,C.floor_types,B.size_sqft,A.pricesqft,A.total_payment,A.token_money,A.discount,A.down_payment,A.recieved_token,A.recieved_downpayment',
							'sale as A',
							'sales_units as B',
							array(
						...
						$con['selection'] = 'A.owners,A.sale_id,D.project_name,D.project_location,C.floor_types,A.pricesqft,A.total_payment,A.token_money,A.discount,A.down_payment,A.recieved_token,A.recieved_downpayment, A.square_feet';
						...
						$con['innerJoin'] = array(array(
					        'table' => 'basic_floors as C',
					        'condition' =>'C.floor_id = A.floor_id',
					        'joinType' => 'inner'
					    ),array(
					        'table' => 'project as D',
					        'condition' =>'D.project_id = C.project_id',
					        'joinType' => 'inner'
					    ));
						$purchases = $this->Admin->getRows($con, 'sale as A');
						if (!empty($purchases)):
							...
							<div class="col-md-12 unit-purchased">
								...
								<table class="table">
									...
									<tr>
										...
										<th>Sold Space</th>
										<td><?php echo $single->square_feet; ?></td>
										<th>Price/sqft</th>
									...
									<tr>
										...
										?></td>
										<th>Space Price After Discount</th>
										<td><?php 
												$discounted = $single->square_feet * $single->pricesqft - $single->discount; 
												echo 'Rs.'.$discounted; 
										?></td>
									</tr>
								</table>
								...
								<table class="table">
									<tr>
										<th>Space Total Price</th>
										<td><?php echo 'Rs.'.$single->square_feet * $single->pricesqft; ?></td>
										<th>Token Money</th>
								...
								<table class="table">
									...
									<tr>
										...
										<td><?php echo 'Rs.'.$each->remaining; ?></td>
										...
										<tr>
											...
											<td><?php 
												if (!empty($single->discount)) {
													echo $totalPriceDiscount - $totalPaid;
												}
												else
												{
