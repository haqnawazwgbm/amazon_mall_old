                    ...
                    <div class="col-md-12 mar-2">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <a href="<?= base_url().'Reports/payment_report/'.$this->uri->segment(3); ?>" class="btn btn-info pull-right">Generate Report</a>
                                <div>
                                    <h3>Payments</h3>
...
<script>
    ...
    {
        $.post('<?php echo base_url('Sales/InitialPayments') ?>', {id:<?php echo $this->uri->segment(3) ?>}, function(data, textStatus, xhr) {
