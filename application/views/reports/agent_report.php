                            ...
                            <div class="panel-body">
                                ...
                                <form id="Report">
                                    <div class="col-md-3">
                                        ...
                                        <select name="agent" class="form-control select" data-live-search="true">
                                            <option>Select Agent</option>
                                            <?php if (!empty($agent)): ?>
                                                <?php foreach ($agent as $get): ?>
                                                    <option value="<?php echo $get->user_id; ?>"><?php echo $get->fullname; ?></option>
                                                <?php endforeach ?>
                                            <?php endif ?>
                                        </select>
                                    </div>
    ...
    <script>
        $(document).ready(function (e) {
            $("#Report").on('submit',(function(e) {
              e.preventDefault();
              $.ajax({
                url: "<?php echo base_url(); ?>Reports/agentReports",
                type: "POST",             
