<?php $this->session->set_userdata('salepdf',$filterData); ?>
<br>
<a style="margin-left:1em;" href="<?php echo base_url('Reports/SaleReportPDF'); ?>" class="btn btn-primary">Print PDF</a>
<br>
<br>
<table class="table table-condensed">
	...
	<tr>
		...
		<td class="text-success" style="font-weight: bold;">Rs.<?php echo $simple->size_sqft*$simple->pricesqft; ?></td>
