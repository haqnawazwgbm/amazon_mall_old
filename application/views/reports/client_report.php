                    ...
                    <div class="col-md-12 mar-2">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <form id="Report">
                                    <div class="col-md-2">
                                        <label for="">Units Purchased</label>
                                        <input type="radio" name="filterby" class="checkbox" value="1">
                                    </div>
                                    <div class="col-md-2">
                                        <label for="">Registered</label>
                                        <input type="radio" name="filterby" class="checkbox" value="0">
                                    </div>
                                    <div class="col-md-2">
    ...
    <script>
        $(document).ready(function (e) {
            $("#Report").on('submit',(function(e) {
              e.preventDefault();
              $.ajax({
                url: "<?php echo base_url(); ?>Reports/clientReports",
                type: "POST",             
