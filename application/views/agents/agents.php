                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mar-2">
                              <ul class="nav nav-tabs bootstrap-tabs">
                                <li class="<?= $this->uri->segment(2) == 'customers' ? 'active' : ''; ?>"><a href="<?= base_url(); ?>Agents/customers">Customers</a></li>
                                <li><a href="<?= base_url(); ?>Agents/users">System Users</a></li>
                              </ul>
...
{
    $('#example').DataTable({
        "ajax": "<?php echo base_url('Agents/getAllAgents') ?>",
        "columns": [
        { "data": "11" },
        { "data": "0" },
        { "data": "1" },
