                            ...
                            <div class="panel-body">
                              <div class="col-md-6">
                                 <div class="authorized">
                                    ...
                                    <form action="<?php echo base_url('Units/UploadFiles') ?>" class="dropzone dropzone-mini">
...
{
    $.ajax({
        url: '<?php echo base_url("Units/getAllFiles") ?>',
        type: 'POST',
        data: {id:<?php echo $id; ?>},
    })
    .done(function(res) {
...
function deleteFile(id)
{
    ...
    {
        getAllfiles();
        $.post('<?php echo base_url('Units/deletefile') ?>', {id:id}, function(data, textStatus, xhr) {
